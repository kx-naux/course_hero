...
VALUES 
    ('PO0000001','Its November' ,'Happy Discount Hour for first week of November','B102', '2024-11-01 00:00:00', '2024-11-08 23:59:59', 'Discount', 20.0, 100.0, 'Terms and conditions apply', 'Inactive', 'USA, Canada'),
    ('PO0000002','Course Mayday', 'Discounts from now until November','CA', '2024-05-01 00:00:00', '2024-10-31 23:59:59', 'Discount', 0.0, 50.0, 'Terms and conditions apply', 'Inactive', 'UK, France'),
    ('PO0000003','Happy Day', 'Discounts for all courses','P9012', '2024-06-01 00:00:00', '2024-06-30 23:59:59', 'Discount', 0.0, 75.0, 'Terms and conditions apply', 'Inactive', NULL),
    ('PO0000004','Discount Happy Hour', 'Happy discounts for one hour only','P2741','2024-07-01 13:00:00', '2024-07-01 14:00:00', 'Discount', 15.0, 80.0, 'Terms and conditions apply', 'Inactive', NULL),
    ('PO0000005','Limited Discountz', 'Discounts for all products','P231' ,'2024-08-01 00:00:00', '2024-08-15 23:59:59', 'Discount', 10.0, 120.0, 'Terms and conditions apply', 'Active', 'Germany, Italy');
...
VALUES 
    ('PC0000001', 'Courses', 'Category for books', '.\img\Product_Category\courses.jpg'),
    ('PC0000002', 'Merchandise', 'Category for merchandise', '.\img\Product_Category\merch.jpeg');

INSERT INTO COURSE_CATEGORY (COURSECAT_ID, CATEGORY_NAME, DESCRIPTION,IMG_URL)
VALUES 
    ('CC0000001', 'Programming', 'Category for programming courses', '.\img\Course_Category\it.jpg'),
    ('CC0000002', 'Business', 'Category for business-related courses','.\img\Course_Category\business.jpg'),
    ('CC0000003', 'Design', 'Category for design courses','.\img\Course_Category\design.jpg'),
    ('CC0000004', 'Language', 'Category for language learning courses','.\img\Course_Category\personal.jpg'),
    ('CC0000005', 'Science', 'Category for science and technology courses','.\img\Course_Category\development.jpg');

INSERT INTO MERCH_CATEGORY (MERCHCAT_ID, CATEGORY_NAME, DESCRIPTION,IMG_URL)
VALUES 
    ('MC0000001', 'T-Shirts', 'Category for t-shirts.','.\img\Merch_Category\tshirt.jpeg'),
    ('MC0000002', 'Mugs', 'Category for mugs and cups.','.\img\Merch_Category\mugs.jpg'),
    ('MC0000003', 'Keychain', 'Category for keychains and souvenirs.','.\img\Merch_Category\keychains.jpg'),
    ('MC0000004', 'Accessories', 'Category for everyday accessories.','.\img\Merch_Category\accessories.jpg'),
    ('MC0000005', 'Stationaries', 'Category for stationaries.','.\img\Merch_Category\stationaries.jpg');
...
VALUES 
    ('AU0000001','.\img\Authors\Authors1.jpeg', 'Lena Watson', 'American', 'Stanford University', 'Nobel Prize in Computer Science', 'Dr. Lena Watson is a renowned computer scientist at     Stanford University, known for her groundbreaking work in artificial intelligence and machine learning.', '2021-08-20', 'Manager At Mooiko',  'https://www.example.com/lenawatson'),
    ('AU0000002','.\img\Authors\Authors2.jpg', 'Max Chen', 'Chinese', 'Massachusetts Institute of Technology', 'Fields Medal in Mathematics', 'Dr. Max Chen is a brilliant mathematician at MIT, recognized for his contributions to number theory and algebraic geometry.', '2022-04-15', 'Manager At SiP', 'https://www.example.com/maxchen'),
    ('AU0000003','.\img\Authors\Authors3.png', 'Emily Park', 'British', 'University College London', 'Turing Award in Computer Science', 'Dr. Emily Park is a cybersecurity expert at UCL, renowned for her innovative algorithms and protocols that enhance online security.', '2023-11-28', 'Manager At MySoftware', 'https://www.example.com/emilypark'),
    ('AU0000004','.\img\Authors\Authors4.jpg', 'Alejandro Lopez', 'Mexican', 'California Institute of Technology', 'Breakthrough Prize in Physics', 'Dr. Alejandro Lopez is a theoretical physicist at Caltech, known for his groundbreaking research in quantum mechanics and string theory.', '2024-03-10', 'Manager At Pentamaster', 'https://www.example.com/alejandrolopez'),
    ('AU0000005', '.\img\Authors\Authors5.png','Sara Khan', 'Indian', 'Harvard University', 'National Medal of Science', 'Dr. Sara Khan is a leading bioinformatician at Harvard, specializing in computational biology and genomics.', '1985-06-25', 'Manager At QuantumMetal', 'https://www.example.com/sarakhan');
...
VALUES 
    ...
    ('U00000002', 'AC0000002', 'Justin Bieber', '1985-09-20', 'BA0000002', 'Staff', '2025-12-31', '2024-04-15 09:15:00', 'Female',null),
    ('U00000003', 'AC0000003', 'Wang ChuQin', '1998-03-10', 'BA0000003', 'Manager', '2023-12-31', '2024-04-15 10:00:00', 'Male',NULL),
    ('U00000004', 'AC0000004', 'Juli', '1976-11-28', 'BA0000004', 'Customer', '2024-12-31', '2024-04-15 10:45:00', 'Female',null),
    ('U00000005', 'AC0000005', 'Calvin', '1995-07-02', 'BA0000005', 'Customer', '2025-12-31', '2024-04-15 11:30:00', 'Male',null);

INSERT INTO BANKCARDINFO (CARDINFOID, USER_ID, CARDTYPE, CARD_HOLDER_NAME, CARD_NO, EXPIRY_DATE, CVV)
VALUES 
    ('BC0000001', 'U00000001', 'Master', 'Jackson Wang', '1234567890123456', '12/28', '123'),
    ('BC0000002', 'U00000002', 'Visa', 'Justin Bieber', '1234067890103050', '12/29', '124'),    
    ('BC0000003', 'U00000003', 'American', 'Wang ChuQin', '4567890123456789', '09/28', '789'),
    ('BC0000004', 'U00000004', 'Discover', 'Juli', '7901234567890129', '03/28', '321'),
    ('BC0000005', 'U00000005', 'Master', 'Calvin', '5678901234567890', '11/27', '654');
...
VALUES 
    ...
    ('SL0000002', 'AU0000002', 'Facebook', 'https://www.facebook.com/lenaWatson2'),
    ('SL0000003', 'AU0000003', 'Instagram', 'https://www.instagram.com/ChenMax'),
    ('SL0000004', 'AU0000004', 'LinkedIn', 'https://www.linkedin.com/in/MaxChen'),  
    ('SL0000005', 'AU0000005', 'YouTube', 'https://www.youtube.com/em.Park');
...
VALUES 
    ('PR0000001', 'PC0000001', 'Learn Algebra Now !!! Build RESTful web API (C#) with Authentication and learn how to consume them in a real world application (.NET 7 API)', 'Algebra Part 1', 1500.0, 5, 4.5, 0.1, '.\img\Product\prod1.jpg','Active'),
    ('PR0000002', 'PC0000001', 'Algebra Rocks Hoodie !!! Build real world e-commerce application using ASP.NET Core MVC, Entity Framework Core and ASP.NET Core Identity.', 'Algebra Rocks Hoodie', 800.0, 4, 4.2, 0.05, '.\img\Product\prod2.jpg','Active'),
    ('PR0000003', 'PC0000001', 'JavaScript!!! Build real world e-commerce application using ASP.NET Core MVC, Entity Framework Core and ASP.NET Core Identity.', 'JavaScript', 100.0, 3, 4.0, 0.0, '.\img\Product\prod3.jpg','Active'),
    ('PR0000004', 'PC0000001', 'Learn C+ Now !!! Build real world e-commerce application using ASP.NET Core MVC, Entity Framework Core and ASP.NET Core Identity.', 'C++', 50.0, 2, 3.8, 0.0, '.\img\Product\prod4.jpg','Active'),
    ('PR0000005', 'PC0000001', 'I Love Bio Tshirt !!! Build real world e-commerce application using ASP.NET Core MVC, Entity Framework Core and ASP.NET Core Identity.', 'I Love Bio Tshirt', 30.0, 1, 4.1, 0.0, '.\img\Product\prod5.jpg','Active'),
    ('PR0000006', 'PC0000002', 'I Love Bio Cup !!! Build real world e-commerce application using ASP.NET Core MVC, Entity Framework Core and ASP.NET Core Identity.', 'I Love Bio Cup', 25.0, 1, 2.0, 2, '.\img\Product\prod6.jpg','Active'),
    ('PR0000007', 'PC0000002', 'Java Hoodie !!! Build real world e-commerce application using ASP.NET Core MVC, Entity Framework Core and ASP.NET Core Identity.', 'Java Hoodie', 99.0, 2, 4.0, 1.5, '.\img\Product\prod7.jpg','Active'),
    ('PR0000008', 'PC0000002', 'Buy Physics Cap Now !!! Build real world e-commerce application using ASP.NET Core MVC, Entity Framework Core and ASP.NET Core Identity.', 'Physics Cap', 60.0, 3, 3.0, 0.0, '.\img\Product\prod8.jpg','Active'),
    ('PR0000009', 'PC0000002', 'Buy Physics Shirts Now! Build real world e-commerce application using ASP.NET Core MVC, Entity Framework Core and ASP.NET Core Identity.', 'Physics Shirt', 60.0, 3, 3.0, 0.0, '.\img\Product\prod9.jpg','Active'),
    ('PR0000010', 'PC0000002', 'Buy Physics laptop cover Now !!! Build real world e-commerce application using ASP.NET Core MVC, Entity Framework Core and ASP.NET Core Identity.', 'Physics Laptop', 60.0, 3, 3.0, 0.0, '.\img\Product\prod10.jpg','Active');
...
VALUES 
    ...
    ('CI0000002', 'PR0000002', 'U00000002', 1, '2024-04-16 11:45:00'),
    ('CI0000003', 'PR0000003', 'U00000003', 3, '2024-04-17 09:15:00'),
    ('CI0000004', 'PR0000004', 'U00000004', 1, '2024-04-18 14:20:00'),
    ('CI0000005', 'PR0000005', 'U00000005', 2, '2024-04-19 13:00:00');
...
VALUES 
    ...
    ('TR0000002', 'U00000002', 200.00, NULL, 0.00, 7.00, 'Cash', 3.00, 204.00, 'SHIPPING', 'SH0000001', '2024-04-14 09:30:00'),
    ('TR0000003', 'U00000003', 120.00, 'PO0000002', 15.00, 4.50, 'Credit/Debit', 2.00, 121.50, 'COMPLETED', 'SH0000003', '2024-04-16 11:20:00'),
    ('TR0000004', 'U00000004', 180.00, NULL, 0.00, 6.75, 'Bank Transfer', 2.75, 183.75, 'SHIPPING', 'SH0000004', '2024-04-17 12:00:00'),
...
VALUES 
    ...
    ('TR0000002', 'PR0000002', 1),
    ('TR0000003', 'PR0000003', 1),
    ('TR0000004', 'PR0000004', 1),
    ('TR0000005', 'PR0000005', 3);
...
VALUES
    ...
    ('USER_CHATROOMS',0),
    ('WISHLIST',5),
    ('ONLINE_BANKING_INFO',5),
    ('USER_ONLINE_BANKING_INFO',5);
...
INSERT INTO KEYWORD (KEYWORD,COURSECAT_ID)
VALUES 
    ('java','CC0000001'),
    ('python','CC0000001'),
    ('c++','CC0000001'),
    ('architecture','CC0000003'),
    ('building','CC0000003');

INSERT INTO ONLINE_BANKING_INFO (ONLINE_BANKING_ID,BANK_NAME,DATE_ADDED)
VALUES
    ('BANK00001', 'MayBank','2024-04-13 10:34:00'),
    ('BANK00002', 'Hong Leong Bank','2024-04-15 03:45:00'),
    ('BANK00003', 'CIMB Bank','2024-04-13 06:09:00'),
    ('BANK00004', 'UOB Bank','2024-04-14 12:39:00'),
    ('BANK00005', 'Public Bank','2024-04-12 08:27:00');

INSERT INTO USER_ONLINE_BANKING_INFO (USER_ONLINE_BANKING_INFO_ID,USER_ID,ONLINE_BANKING_ID,DATE_ADDED)
VALUES
    ('UBNK00001','U00000001','BANK00001','2024-04-23 10:38:00'),
    ('UBNK00002','U00000002','BANK00002','2024-04-27 06:32:00'),
    ('UBNK00003','U00000003','BANK00003','2024-04-20 17:09:00'),
    ('UBNK00004','U00000004','BANK00004','2024-05-01 19:27:00'),
    ('UBNK00005','U00000005','BANK00005','2024-05-04 22:43:00');
