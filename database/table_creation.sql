...
CREATE TABLE COURSES(
    ...
    DETAILED_DESC VARCHAR(500) NOT NULL,    
...
CREATE TABLE ONLINE_BANKING_INFO(
    ONLINE_BANKING_ID VARCHAR(9) PRIMARY KEY,
    BANK_NAME VARCHAR(30) NOT NULL,
    DATE_ADDED DATE
);

CREATE TABLE USER_ONLINE_BANKING_INFO(
    USER_ONLINE_BANKING_INFO_ID VARCHAR(9) PRIMARY KEY,
    USER_ID VARCHAR(9) NOT NULL,
    ONLINE_BANKING_ID VARCHAR(9) NOT NULL,
    DATE_ADDED DATE,
    FOREIGN KEY(ONLINE_BANKING_ID) REFERENCES ONLINE_BANKING_INFO(ONLINE_BANKING_ID),
    FOREIGN KEY(USER_ID) REFERENCES USERS(USER_ID)
);